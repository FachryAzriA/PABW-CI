...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Nov 2020 pada 14.26
...
('J3C218001', 'Fachry Azri', 'Pria', 1, 'Jl jalan', 'blank.png', 'Jakarta', '2020-11-12');
...
('fachry', 'caf1a3dfb505ffed0d024130f58c5cfa');
...
('C', 'Manajemen Informatika', 'Sofiyanti Indriasari, M.Kom.'),
('D', 'Teknik Komputer', 'Dr. Shelvie Nidya Neyman, M.Kom.');
...
--
ALTER TABLE `agama`
  MODIFY `kode_agama` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `hobi`
--
ALTER TABLE `hobi`
  MODIFY `kode_hobi` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `hobi_mahasiswa`
--
ALTER TABLE `hobi_mahasiswa`
  MODIFY `kode_hobi_mahasiswa` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT untuk tabel `mahasiswa`
--
ALTER TABLE `mahasiswa`
  MODIFY `kode_agama` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
